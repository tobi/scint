...
module Bundler2::PubGrub
  # Types:
  #
  # Where possible, Bundler2::PubGrub will accept user-defined types, so long as they quack.
  #
  # ## "Package":
  #
  ...
  # parse_dependency to convert it to a format Bundler2::PubGrub understands.
  #
  ...
  class BasicPackageSource
    ...
    # Override me!
    #
    # Convert a (user-defined) dependency into a format Bundler2::PubGrub understands.
    #
    # Package is passed to this method but for many implementations is not
    # needed.
    #
    # Returns: either a Bundler2::PubGrub::VersionRange, Bundler2::PubGrub::VersionUnion, or a
    #   Bundler2::PubGrub::VersionConstraint
    ...
    def incompatibilities_for(package, version)
      ...
      package_deps[version].map do |dep_package, dep_constraint_name|
        ...
        if !dep_constraint
          ...
          cause = Bundler2::PubGrub::Incompatibility::InvalidDependency.new(dep_package, dep_constraint_name)
