module Bundler2::PubGrub
  class Incompatibility
    ...
    def to_s
      ...
      when Bundler2::PubGrub::Incompatibility::InvalidDependency
        "#{terms[0].to_s(allow_every: true)} depends on unknown package #{cause.package}"
      when Bundler2::PubGrub::Incompatibility::NoVersions
        "no versions satisfy #{cause.constraint}"
      when Bundler2::PubGrub::Incompatibility::ConflictCause
        if failure?
