  ...
  module Runtime
    module Exec
      ...
      def exec(command, args, lock_path)
        ...
        bundler2_lib_dir = File.expand_path("../..", __dir__)
        ...
        # Order matters: bundler2 lib first, then gem load paths.
        paths.unshift(bundler2_lib_dir)
      ...
      def export_original_env(original_env)
        ENV["BUNDLER2_ORIGINAL_ENV"] ||= Base64.strict_encode64(Marshal.dump(original_env))
